...
![](/images/WPOptimizationSuiteInterface.png)

3. Find a website for which you want to apply the Object Cache plugin and turn it on
...
Click on the ![](/images/ChangeLimit.png) to change the limit.
...
![](/images/MisconfigurationMessage.png)
...
![](/images/UnexpectedWordPressError.png)
